...
const aiProjects: AIProject[] = [
  ...
  {
    title: "広告シナリオ自動化",
    description: "広告クリエイティブの制作フローをAIで自動化。過去の実績データを分析・構造化し、データベースを設計。AIに学習させることで、新規シナリオを自動生成する仕組みを構築。",
    results: "手作業10時間 → AIで10分に短縮",
  ...
  {
    title: "広告レポート自動化",
    description: "手作業で行っていた広告レポートの集計・分析をAIで自動化。最新の広告トレンドを自動収集し、分析結果をスプレッドシートにランキング形式で出力。",
    results: "手作業2〜3時間の集計 → ボタン1つ・5分で完了",
    ...
    channels: [
      {
        ...
        youtube: "https://youtube.com/@_anariso_",
