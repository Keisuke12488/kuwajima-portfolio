...
const aiProjects: AIProject[] = [
  ...
  },
  {
    ...
    processes: ["ワークフロー設計", "プロンプト設計", "自動化構築", "運用"],
    tech: ["Claude API", "自動化ワークフロー"],
    status: "運用中",
    icon: MessageSquare,
  },
    ...
    channels: [
      {
        ...
        subscribers: "55万人",
        period: "3年（現在も運用中）",
        roles: ["ディレクション（全体統括）", "企画立案・戦略設計", "シナリオライターのディレクション", "撮影ディレクション", "編集ディレクション"],
      ...
      },
      {
        ...
        subscribers: "5万人",
        period: "1年半",
        roles: ["0→1の構想設計", "企画案の立案", "ディレクション連携"],
